        ...
        <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number"><?= $td; ?></span>
                </div>
                <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                for (i = 0; i < data.length; i++) {
                    ...
                    html += '<tr>' +
                        '<td>' + no + '</td>' +
                        '<td>' + '<div class="progress-group"><span class="progress-text">' + data[i].namap + '</span><span class="float-right"><b>' + data[i].do + '</b>/' + data[i].total * 3 + '</span><div class="progress progress-sm"><div class="progress-bar bg-' + y[Math.floor(Math.random() * y.length)] + '" style="width: ' + Math.round((data[i].do / (data[i].total * 3)) * 100) + '%"></div></div><td><span class="badge bg-' + warna + '">' + Math.round((data[i].do / (data[i].total * 3)) * 100) + '%</span></td></div>' + '<td>' +
                        '</tr>';
                    no++;
                }
