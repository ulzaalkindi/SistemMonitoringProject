<div class="mt-4 container">
    <div class="row">
        <div class="col-md-4">
            <div class=" card card-info card-outline">
                <div class="card-body box-profile">
                    ...
                    <p class="text-muted text-center"> <?= $profile['perusahaan'] ?></p>
        ...
        <div class="col-md">
            ...
            <div class="row">
                <div class="col-md-2">
                    <a href="<?= base_url('client/edit_profile/' . $profile['id']); ?>" class="btn btn-secondary btn-block "><i class="fas fa-pencil-alt mr-1"></i> <b>Edit</b></a>
                </div>
            </div>
