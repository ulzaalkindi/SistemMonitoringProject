...
<aside class="main-sidebar sidebar-light-info nav-compat elevation-2">
    <!-- Brand Logo -->
    <a href="<?= base_url('devel'); ?>" class="brand-link navbar-info">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                <li class="nav-item">
                    <a href="<?= base_url('devel'); ?>" class="nav-link">
                ...
                <li class="nav-item">
                    <a href="<?= base_url('devel/project'); ?>" class="nav-link">
                ...
                <li class="nav-item">
                    <a href="<?= base_url('devel/profile'); ?>" class="nav-link">
